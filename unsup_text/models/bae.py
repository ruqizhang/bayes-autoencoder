...
class Encode(nn.Module):
    ...
    def __init__(self,x_dim,z_dim,hidden_dim,vocab_size,dropout,bsz,device_id=None):
...
class BAE_LSTM(nn.Module):
    ...
    def __init__(self, ntoken, ninp, nhid, zdim, nlayers, bsz=64,dropout=0.5, tie_weights=False):
        ...
        self.encoder = Encode(ninp,zdim,nhid,ntoken,dropout,bsz)
        self.decoder = Decode(ninp,zdim,nhid,ntoken,dropout,bsz)
