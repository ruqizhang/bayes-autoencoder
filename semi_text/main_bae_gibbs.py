...
import itertools
parser = argparse.ArgumentParser(description='PyTorch Bae gibbs')
...
for epoch in range(1, args.epochs+1):
    ...
    if epoch > 80:
        print('save!')
        torch.save(model.state_dict(),'./checkpoints/baeg_label%d_seed%d_%i.pt'%(args.numlabel,args.seed,mt))
        mt += 1
    print('-' * 89)
